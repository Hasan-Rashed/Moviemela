...
import { getNowPlayingMovies } from '../slices/nowPlayingSlice';
...
const nowPlayingMovies = useSelector(state => state.moviesRoot2.now_playing);
console.log(nowPlayingMovies);


// useEffect to dispatch the getNowPlayingMovies action
useEffect(() => {

    dispatch(getNowPlayingMovies()); // dispatch the getNowPlayingMovies action
        ...
        <div className="container py-10 px-5 mx-auto items-center justify-center grid grid-cols-1 md:grid-cols-4 gap-3">
...

            {
                ...
                nowPlayingMovies?.isLoading ? (
                    ...
                    nowPlayingMovies?.data?.map((movie) => (
